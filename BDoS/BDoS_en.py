...
def helptext ():
        print "Usage: %s is 1.0 for GNU/Linux - <hostname> [-t] [-c] [-p]\n" % sys.argv[0]
        print " EX. python BDoS.py www.website.com -t 1000 -c 1000 -p 80"
        print ""
        print " HTTP method"
        print ""
...
def sender (num):
        ...
        col()
        print " BDoS thread %d started" % num
        ...
        while True:
                ...
                col()
                print " Thread %d opened %d connections" % (num, connection_amount)
                ...
                if bleh:
                        for c in cons:
                                try:
                                        ...
                                        pass
                        col()
                        print " :( Thread %d died, restarting" % num
                        cons = []
                        continue
